import type { BrasaPointsRegistration } from './types/models';
import {
  aggregateNumbers,
  binarySearch,
...
const registrations: BrasaPointsRegistration[] = [
  {
    ...
    dietaryPreferences: ['Sin gluten'] as Array<'Sin gluten'>,
    source: 'Recomendación' as const,
  ...
  },
  {
    ...
    country: 'Estados Unidos' as const,
    city: 'Miami',
    favoriteLocation: 'Brasaland Brickell',
    dietaryPreferences: ['Vegetariano'] as Array<'Vegetariano'>,
  ...
  },
  {
    ...
    dietaryPreferences: ['Sin restricciones'] as Array<'Sin restricciones'>,
    source: 'Pasando por el local' as const,
